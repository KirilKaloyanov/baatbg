...
export default function LanguageSwitch({ locale }) {
  ...
  return (
    <>
      <div
        className="relative inline-flex items-center justify-end w-20 h-10 px-1 py-1 font-medium text-sm bg-gray-200 rounded-full cursor-pointer"
        onClick={switching}
      >
        ...
        <motion.div
          ...
          className={`absolute top-0 left-0 w-1/2 h-full bg-primary-foreground rounded-full z-0 ${
