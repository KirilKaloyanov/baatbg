...
export default function ViewContent() {
  ...
  return (
    <div>
      ...
      <div style={{maxWidth: '650px'}} data-ephox-embed-iri="https://youtu.be/aPuwVkLwcgk?si=LPQwHCZaUDGFXRc_"> 
        <div style={{left: 0, width: "100%", height: 0, position: "relative", paddingBottom: "56.25%"}}>
          ...
          src={content?.ytLink} //https://www.youtube.com/embed/MQc6ws2LmW8?rel=0
